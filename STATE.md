...
CIRED et ENPC : collection Zotero privée partagée avec PDFs attachés, métadonnées
structurées (~740 documents). Succès = un chercheur CIRED/ENPC peut trouver et
télécharger n'importe quelle publication via Zotero, avec métadonnées correctes.
...
**Suite:** 0015 (importer corrections métadonnées d'Antonin depuis le groupe Recueil_CIRED, groupe→perso, par id YYYY-NN).
